...
public class WoyarnBean {
	...
	public String file_num_warn;
	public String file_num_crit;
	...
	public void setQueue_info(String queue_info) {
	...
	public String getFile_num_warn() {
		return file_num_warn;
	}
	public void setFile_num_warn(String file_num_warn) {
		this.file_num_warn = file_num_warn;
	}
	public String getFile_num_crit() {
		return file_num_crit;
	}
	public void setFile_num_crit(String file_num_crit) {
		this.file_num_crit = file_num_crit;
	}
