...
<jsp:include page="/WEB-INF/pages/include/sessionif.jsp" ></jsp:include>
	<div id="wrapper" >
	<jsp:include page="/WEB-INF/pages/include/leftside_forinapp.jsp"></jsp:include>
...
<iframe  src="http://132.35.224.147:7670/ganglia/?r=hour&cs=&ce=&m=load_one&s=by+name&c=yz-301-01-redis&tab=m&vn=&hide-hf=false" style="height: 100%;width: 100%; border:#000;solid:1px;border-top:none;border-bottom:none;"></iframe>
</div>
	...
	<!-- Custom and plugin javascript -->
	 ...
	 $(function(){
			// var id1=document.getElementById("sc");
			 ...
			 $('#forin_app').toggleClass('active');
			 $('#forin_redis').toggleClass('active');
