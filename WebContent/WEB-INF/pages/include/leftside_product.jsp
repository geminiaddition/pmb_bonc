...
<nav class="navbar-default navbar-static-side" role="navigation">
		<div class="sidebar-collapse">
			<ul class="nav metismenu" id="side-menu">
				...
				<li id="sc" ><a><i class="fa fa-gears"></i> <span
					...
					<ul id="ul" class="nav nav-second-level collapse in">
					...
					<ul id="scxqul" class="nav nav-third-level collapse in">
	...
	<li id="datacenter"><a href="datacenter/datacenter!datacenter.action"><i class="fa fa-gears"></i><span
						...
						<li id="toout"><a href="tooout/tooout!tooout.action"><i class="fa fa-gears"></i><span
