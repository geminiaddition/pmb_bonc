...
<jsp:include page="/WEB-INF/pages/include/sessionif.jsp" ></jsp:include>
	<div id="wrapper" >
	<jsp:include page="/WEB-INF/pages/include/leftside_tooout.jsp"></jsp:include>
...
<iframe  src="http://10.162.6.15/ganglia/?r=hour&cs=&ce=&m=load_one&s=by+name&c=lf-324-03-open1&tab=m&vn=&hide-hf=false" style="height: 100%;width: 100%;border:#000;solid:1px;border-top:none;border-bottom:none;"></iframe>
</div>
	...
	<!-- Custom and plugin javascript -->
	 ...
	 $(function(){
			// var id1=document.getElementById("sc");
			 ...
			 $('#tooout_app').toggleClass('active');
			 $('#tooout_apppowerfor').toggleClass('active');
