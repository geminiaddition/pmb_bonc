...
<jsp:include page="/WEB-INF/pages/include/sessionif.jsp" ></jsp:include>
	...
	<jsp:include page="/WEB-INF/pages/include/leftside_home.jsp"></jsp:include>
		...
		<div id="page-wrapper" class="gray-bg dashbard-1" style="background: black;">
			<jsp:include page="/WEB-INF/pages/include/head.jsp"></jsp:include>

 <div class="row wrapper border-bottom white-bg page-heading" style="background-color: black;">
                <div class="col-lg-5">
                    <h2 style="color: white;">大屏生产</h2>
                    <ol class="breadcrumb">
...
<iframe  src="http://10.249.217.246:8080/auth-wscreen/datamonitorPro/index" style="height: 100%;width: 100%;"></iframe>
</div>
<div id="morejsp" style="display: none;" >
	...
	<!-- Custom and plugin javascript -->
	 ...
	 $(function(){
			// var id1=document.getElementById("sc");
			 ...
			 $('#ul').toggleClass('nav nav-second-level collapse in');
			 $('#dapingshengchan').toggleClass('active');
