...
<iframe  src="http://10.161.19.2/ganglia" style="height: 100%;width: 100%; border:#000;solid:1px;border-top:none;border-bottom:none;"></iframe>
</div>
	...
	<!-- Custom and plugin javascript -->
	 ...
	 $(function(){
			// var id1=document.getElementById("sc");
			 ...
			 $('#data_onecluster').toggleClass('active');
