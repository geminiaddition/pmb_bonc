...
<iframe  src="http://10.162.166.189/ganglia/?r=hour&cs=&ce=&m=load_one&s=by+name&c=ipsource&tab=m&vn=&hide-hf=false" style="height: 100%;width: 100%;  border:#000;solid:1px;border-top:none;border-bottom:none;"></iframe>
</div>
	...
	<!-- Custom and plugin javascript -->
	 ...
	 $(function(){
			...
			$('#data_center').toggleClass('active');
			 $('#data_fourIPsource').toggleClass('active');
