...
<iframe  src="http://10.161.26.47/ganglia/?r=hour&cs=&ce=&m=load_one&s=by+name&c=YZ-301-01-web&tab=m&vn=&hide-hf=false" style="height: 100%;width: 100%; border:#000;solid:1px;border-top:none;border-bottom:none;"></iframe>
</div>
	...
	<!-- Custom and plugin javascript -->
	 ...
	 $(function(){
			// var id1=document.getElementById("sc");
			 ...
			 $('#data_onecluster_cb').toggleClass('active');
