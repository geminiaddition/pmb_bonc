...
<iframe  src="http://10.162.6.13/ganglia/?r=hour&cs=&ce=&m=load_one&s=by+name&c=lf-324-01-yzwk&tab=m&vn=&hide-hf=false" style="height: 100%;width: 100%; border:#000;solid:1px;border-top:none;border-bottom:none;"></iframe>
</div>
	...
	<!-- Custom and plugin javascript -->
	 ...
	 $(function(){
			...
			$('#data_center').toggleClass('active');
			 $('#data_onetofive').toggleClass('active');
